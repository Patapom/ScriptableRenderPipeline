Shader "HDRenderPipeline/AxF"
{
	Properties
	{
		...
		[Enum( SVBRDF, BTF, CarPaint )] _BRDFType( "BRDF Type", Int ) = 0
//		[HideInInspector] _BRDFType("_BRDFType", Float) = 0.0
		...
		// SVBRDF maps
		_SVBRDF_DiffuseColor("_SVBRDF_DiffuseColor", 2D) = "white" {}
		_SVBRDF_SpecularColor("_SVBRDF_SpecularColor", 2D) = "white" {}
		_SVBRDF_SpecularLobe("_SVBRDF_SpecularLobe", 2D) = "white" {}
		_SVBRDF_Fresnel("_SVBRDF_Fresnel", 2D) = "white" {}
		_SVBRDF_Normal("_SVBRDF_Normal", 2D) = "white" {}
